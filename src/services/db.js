...
// NOTE: no client name is ever hard-coded in the application. Every user name
// used by the code comes from the database — the Firestore collections
// (`clientProfiles`, `reservations`, `orders`, `reviews`) that are mirrored into
// this browser's cache at load time and streamed live through the subscriptions.
